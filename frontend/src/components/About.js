...
import image1 from '../image/profiles/2.jpg'
import image2 from '../image/profiles/hello.jpg'
import image3 from '../image/profiles/5.jpg'
                ...
                <section className="founders-section">
                    ...
                    <div className="founders-list">
                        <div className="founder founder1">
                            <img src={image1} alt="Founder 1" className="founder-image" />
                            <h3 className="founder-name">Aashish Sapkota</h3>
                            <p className="founder-role">Co-Founder</p>
                            <div className="social-media social-media-founder1">
                                <a href={'../image/profiles/2.jpg'} target="_blank" aria-label="LinkedIn"
                                    className="linkedin">
                        ...
                        <div className="founder founder2">
                            <img src={image2} alt="Founder 2" className="founder-image" />
                        ...
                        <div className="founder founder3">
                            <img src={image3} alt="Founder 3" className="founder-image" />
